        ...
        <div className="flex flex-col gap-1 w-full">
          ...
          <div className="flex flex-wrap items-center mt-3 gap-2">
            <a
              ...
              className="h-8 lg:h-9 px-3 lg:px-4 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium text-xs lg:text-sm rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors flex items-center gap-2"
            >
